...
-(void)setHeader:(MQRefreshHeaderView *)header {
...
- (MQRefreshHeaderView *)header
{
    return objc_getAssociatedObject(self, &MJRefreshHeaderKey);
}
#pragma mark - footer
static const char MJRefreshFooterKey = '\0';
- (void)setFooter:(MQRefreshFooterView *)footer
{
